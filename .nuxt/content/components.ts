export const ArticleComments = () => import('./../../components/ArticleComments.vue')
export const GiscusComments = () => import('./../../components/GiscusComments.vue')
export const HeaderNav = () => import('./../../components/HeaderNav.vue')
export const NewsletterCta = () => import('./../../components/NewsletterCta.vue')
export const PostCard = () => import('./../../components/PostCard.vue')
export const TagPill = () => import('./../../components/TagPill.vue')
...
export const localComponents: string[] = ["ArticleComments","GiscusComments","HeaderNav","NewsletterCta","PostCard","TagPill","NuxtWelcome","NuxtLayout","NuxtErrorBoundary","ClientOnly","DevOnly","ServerPlaceholder","NuxtLink","NuxtLoadingIndicator","NuxtTime","NuxtRouteAnnouncer","NuxtImg","NuxtPicture","ContentRenderer","MDC","MDCCached","MDCRenderer","MDCSlot","NuxtPage","NoScript","Link","Base","Title","Meta","Style","Head","Html","Body","NuxtIsland"]