...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, getRouterParam, setHeader, getResponseStatus, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatusText } from 'file:///Users/stefano/Progetti/t1diario/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/stefano/Progetti/t1diario/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/stefano/Progetti/t1diario/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///Users/stefano/Progetti/t1diario/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/stefano/Progetti/t1diario/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/stefano/Progetti/t1diario/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/stefano/Progetti/t1diario/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/stefano/Progetti/t1diario/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/stefano/Progetti/t1diario/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/stefano/Progetti/t1diario/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/stefano/Progetti/t1diario/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/stefano/Progetti/t1diario/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/stefano/Progetti/t1diario/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/stefano/Progetti/t1diario/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/stefano/Progetti/t1diario/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/stefano/Progetti/t1diario/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/stefano/Progetti/t1diario/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/stefano/Progetti/t1diario/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/stefano/Progetti/t1diario/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/stefano/Progetti/t1diario/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/stefano/Progetti/t1diario/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/stefano/Progetti/t1diario/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/stefano/Progetti/t1diario/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/stefano/Progetti/t1diario/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///Users/stefano/Progetti/t1diario/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/stefano/Progetti/t1diario/node_modules/nuxt/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/stefano/Progetti/t1diario/node_modules/nuxt/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/stefano/Progetti/t1diario/node_modules/nuxt/node_modules/unhead/dist/utils.mjs';
import { isAbsolute } from 'file:///Users/stefano/Progetti/t1diario/node_modules/@nuxt/content/node_modules/pathe/dist/index.mjs';
import localAdapter from 'file:///Users/stefano/Progetti/t1diario/node_modules/db0/dist/connectors/better-sqlite3.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/stefano/Progetti/t1diario/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/stefano/Progetti/t1diario","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/stefano/Progetti/t1diario/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/stefano/Progetti/t1diario/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/stefano/Progetti/t1diario/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/stefano/Progetti/t1diario/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/stefano/Progetti/t1diario/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _zLV2znfUfGXVDi_N5O5CpyHznFAforQaXuxqf_znQFE = (function(nitro) {
...
const _hzeLp6Hm1GUOBakOrFQykkf0WsUXTe9ifDzit5eiyB0 = (nitroApp) => {
...
const plugins = [
  _zLV2znfUfGXVDi_N5O5CpyHznFAforQaXuxqf_znQFE,
_hzeLp6Hm1GUOBakOrFQykkf0WsUXTe9ifDzit5eiyB0
];
...
const _is9V0n = eventHandler((event) => {
...
const getServerEntry = () => import('file:///Users/stefano/Progetti/t1diario/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/stefano/Progetti/t1diario/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _N7dV0E = eventHandler(async (event) => {
  ...
  return await import('file:///Users/stefano/Progetti/t1diario/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _B9NE4X = eventHandler(async (event) => {
...
const _lazy_ITtUEg = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _is9V0n, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_ITtUEg, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _N7dV0E, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _B9NE4X, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_ITtUEg, lazy: true, middleware: false, method: undefined }
];
